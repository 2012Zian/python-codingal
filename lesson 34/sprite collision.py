...
FONT_SIZE = 72
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("C:\\Users\\User\\python-codingal\\lesson 34\\download.jpg"),(SCREEN_WIDTH, SCREEN_HEIGHT))
...
sprite2 = sprite(pygame.Color('pink'),20, 30)
